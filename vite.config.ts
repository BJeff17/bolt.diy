...
export default defineConfig((config) => {
  ...
  return {
    ...
    plugins: [
      ...
      // Conditionally load Cloudflare proxy - skip during production builds
      ...
      remixVitePlugin({
        ...
        // Disable server bundling during build to prevent EPIPE
        ...(isBuild && {
    ...
    // Server configuration to prevent EPIPE errors
    server: {
      // Disable during build process
      middlewareMode: isBuild,
      hmr: !isBuild,
    },
